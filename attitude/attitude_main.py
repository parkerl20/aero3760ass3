...
def main():
    ...
    plt.savefig("../figures/at_euler_angles_iterations.png")
    ...
    plt.xlabel("Iterations")
    plt.ylabel("Value")
    plt.savefig("../figures/at_convergence_of_NLLS.png")
    ...
    plt.ylabel("DOPs")
    plt.xlabel("Timesteps")
    plt.savefig("../figures/at_DOP_overtime.png")
    ...
    plt.savefig("../figures/at_iterations_convergence.png")
